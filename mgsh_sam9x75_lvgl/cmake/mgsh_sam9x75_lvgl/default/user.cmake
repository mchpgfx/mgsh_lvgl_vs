...
mgsh_sam9x75_lvgl_default_default_XC32_compile_rule(lvgl_lib)
...
if(TARGET mgsh_sam9x75_lvgl_default_default_XC32_compile)
    add_lvgl_includes(mgsh_sam9x75_lvgl_default_default_XC32_compile)
endif()

if(TARGET mgsh_sam9x75_lvgl_default_default_XC32_compile_cpp)
    add_lvgl_includes(mgsh_sam9x75_lvgl_default_default_XC32_compile_cpp)
endif()

# Link LVGL objects to the main executable target
get_property(all_targets DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}" PROPERTY BUILDSYSTEM_TARGETS)
foreach(target ${all_targets})
    if(target MATCHES "^mgsh_sam9x75_lvgl_default_image_")
