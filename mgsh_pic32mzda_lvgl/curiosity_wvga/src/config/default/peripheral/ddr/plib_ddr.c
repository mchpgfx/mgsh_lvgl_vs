...
static void DDR_Init(void)
{
    ...
    DDRMINLIMbits.MINLIMIT = 0x2U;
    DDRTSELbits.TSEL = (uint8_t)DDR_TARGET_0 * 8U;
    DDRRQPERbits.RQPER = 0xfeU;
    DDRTSELbits.TSEL = (uint8_t)DDR_TARGET_0 * 8U;
    DDRMINCMDbits.MINCMD = 0x1U;
    ...
    DDRMINLIMbits.MINLIMIT = 0x1eU;
    DDRTSELbits.TSEL = (uint8_t)DDR_TARGET_2 * 8U;
    DDRRQPERbits.RQPER = 0x1U;
    DDRTSELbits.TSEL = (uint8_t)DDR_TARGET_2 * 8U;
    DDRMINCMDbits.MINCMD = 0xfeU;
    
    DDRTSELbits.TSEL = ((uint8_t)DDR_TARGET_3 * 5U);
    DDRMINLIMbits.MINLIMIT = 0x1U;
