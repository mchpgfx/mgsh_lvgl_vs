...
target_include_directories(lvgl_lib
    ...
    PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../curiosity_wvga/src/config/default"
    PRIVATE "${LVGL_ROOT}"
    PRIVATE "${LVGL_ROOT}/src"
    PRIVATE "${LVGL_ROOT}/demos"
)

# Apply same compile options from generated rule.cmake
mgsh_pic32mzda_lvgl_default_default_XC32_compile_rule(lvgl_lib)
...
if(TARGET mgsh_pic32mzda_lvgl_default_default_XC32_compile)
    add_lvgl_includes(mgsh_pic32mzda_lvgl_default_default_XC32_compile)
endif()

if(TARGET mgsh_pic32mzda_lvgl_default_default_XC32_compile_cpp)
    add_lvgl_includes(mgsh_pic32mzda_lvgl_default_default_XC32_compile_cpp)
endif()

# Link LVGL objects to the main executable target
get_property(all_targets DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}" PROPERTY BUILDSYSTEM_TARGETS)
foreach(target ${all_targets})
    if(target MATCHES "^mgsh_pic32mzda_lvgl_default_image_")
