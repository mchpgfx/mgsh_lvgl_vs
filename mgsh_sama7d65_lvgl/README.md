...
LVGL graphics demo project for the Microchip SAMA7D65 microprocessor running on the Curiosity development board with a WVGA (800x480) display.

## Overview

This project demonstrates the integration of [LVGL](https://lvgl.io/) (Light and Versatile Graphics Library) v9.5.0 with the MPLAB Harmony v3 framework on the SAMA7D65 MPU. It uses the XLCDC (eXtended LCD Controller) display driver for graphics output and the Input System Service with MaxTouch driver for capacitive touch input.

## Hardware Requirements

- **MCU**: SAMA7D65D2G (Arm Cortex-A7 core)
- **Board**: [SAMA7D65 Curiosity Development Board](https://www.microchip.com/en-us/development-tool/EV24P60A) (EV24P60A)
- **Display**: [5" LVDS WVGA 800x480 maXTouch Display Module](https://www.microchipdirect.com/product/AC69T88A) (AC69T88A)
- **Power**: USB-C cable or 5V power adapter
- **Debugger/Programmer**: J-Link or compatible

For detailed hardware setup instructions, see the [Hardware Setup Guide](https://developerhelp.microchip.com/xwiki/bin/view/software-tools/mgs/dev-kits/sama7dg65-mgsh-ug/hw-guide-ac68t88a/).
...
2. The MPLAB extension will detect the project from `.vscode/mgsh_sama7d65_lvgl.mplab.json`
...
```bash
cd _build/mgsh_sama7d65_lvgl/default
cmake --build .
```
...
| PIT64B/TC | Timer for system time and LVGL ticks |
...
- [SAMA7D65 Product Page](https://www.microchip.com/en-us/product/SAMA7D65)
